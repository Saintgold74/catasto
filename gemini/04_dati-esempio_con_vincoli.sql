...
ON CONFLICT (comune_nome, anno_impianto) DO NOTHING;
...
ON CONFLICT (comune_nome, nome_completo) DO NOTHING;
...
ON CONFLICT (comune_nome, nome, tipo, civico) DO NOTHING;
...
ON CONFLICT (comune_nome, numero_partita) DO NOTHING;
...
--ON CONFLICT (comune_nome, codice_immobile) DO NOTHING;
...
--ON CONFLICT (comune_nome, codice_variazione) DO NOTHING;
